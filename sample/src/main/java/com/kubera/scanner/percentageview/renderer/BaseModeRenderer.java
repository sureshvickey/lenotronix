...
package com.kubera.scanner.percentageview.renderer;
...
public abstract class BaseModeRenderer {
    ...
    private void initGradientColors(TypedArray attrs) {
        ...
        if (gradientColors != null) {
            ...
            mGradientColors[0] = Color.parseColor("#3F51B5");
            mGradientColors[1] = Color.parseColor("#ff00ddff");
            mGradientColors[2] = Color.parseColor("#536c67");
        }
