...
public class RingModeRenderer extends BaseModeRenderer implements OrientationBasedMode {
    ...
    private void init(TypedArray attrs) {
        ...
        //BACKGROUND WIDTH
        mBackgroundBarThickness = attrs.getDimensionPixelSize(R.styleable.PercentageChartView_pcv_backgroundBarThickness,
        ...
        int cap = attrs.getInt(R.styleable.PercentageChartView_pcv_progressBarStyle, CAP_ROUND);
